      ...
      <ReactSideNav visible={visible} hide={hide}>
        <div className="SideNav__content">
          ...
          <Link replace to="/ecka" className="SideNav__link">
            <svg width="30" height="30"><use xlinkHref={`${imgSprite}#list`}></use></svg>
            Seznam éček
          </Link>
          ...
          <a href="https://play.google.com/store/apps/details?id=cz.viscokupujes.mnamka" target="_blank" className="SideNav__link">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 612 612" fill="currentColor"><path d="M610.95 238.72a24.428 24.428 0 0 0-18.454-16.848l-188.994-37.845-75.365-169.641C324.255 5.666 315.535.025 305.973.025c-9.562 0-18.263 5.679-22.183 14.419l-75.327 169.604-189.051 37.844c-8.739 1.798-15.758 8.223-18.358 16.81-2.62 8.472-.268 17.746 6.081 24.171L138.798 394.44l-36.793 188.402c-1.836 9.197.535 18.109 7.649 23.826 4.246 3.348 9.696 5.184 15.356 5.184 3.404 0 6.731-.707 9.753-2.084l171.21-75.959 171.498 76.055c2.906 1.395 6.138 2.104 9.638 2.104 5.45 0 10.805-1.855 15.03-5.221 7.152-5.68 9.562-14.859 7.822-23.904l-36.889-188.441L604.85 262.834c6.349-6.329 8.701-15.585 6.1-24.114zm-178.4 115.103c-13.521 13.5-19.448 32.854-15.758 51.613l24.573 125.639-112.119-49.721a57.3 57.3 0 0 0-46.527 0l-112.177 49.76 24.574-125.697a57.36 57.36 0 0 0-15.758-51.574L91.43 265.971l128.259-25.664a57.352 57.352 0 0 0 41.172-32.968l45.111-101.525 45.112 101.544a57.37 57.37 0 0 0 41.153 32.969l128.298 25.682-87.985 87.814z"/></svg>
            Ohodnoťte aplikaci
          </a>
